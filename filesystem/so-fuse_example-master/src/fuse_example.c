 ...
 */
#define DEFAULT_FILE_CONTENT "este es el valor por default del contenido de un archivo creado en la grasada esta!\n"

/*
 * Este es el nombre del archivo que se va a encontrar dentro de nuestro FS
 */
#define DEFAULT_FILE_NAME "whitesnake es una banda poser"
